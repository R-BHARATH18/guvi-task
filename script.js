...
for (let i=0;i<data.length;i++) {
  row.innerHTML += `  
          ...
          <div clas="card-header text-center bg-dark h4" id="Name">${data[i].name}</div>
          <div class="pt-2 bg">
          <div class="card-body">
   ...
   <p id="Country codes">countrycode:${data[i].alpha3Code}</p>
 ...
 function weatherApiCall(test) {
 fetch("https://api.openweathermap.org/data/2.5/weather?q=" + test + "&appid=2e9de9dc680a1b5899154c44455b0184")
    .then(function(val){
